/* Automatically generated by gen_abi from /home/michiel/paparazzi/conf/abi.xml */
/* Version v5.13_devel-166-gae18987 */
/* Please DO NOT EDIT */
...
typedef void (*abi_callbackUWB_COMMUNICATION)(uint8_t sender_id, uint8_t id, float range, float vx, float vy, float h);
...
static inline void AbiSendMsgUWB_COMMUNICATION(uint8_t sender_id, uint8_t id, float range, float vx, float vy, float h) {
  abi_event* e;
  ABI_FOREACH(abi_queues[ABI_UWB_COMMUNICATION_ID],e) {
    if (e->id == ABI_BROADCAST || e->id == sender_id) {
      abi_callbackUWB_COMMUNICATION cb = (abi_callbackUWB_COMMUNICATION)(e->cb);
      cb(sender_id, id, range, vx, vy, h);
    }
  }
}
