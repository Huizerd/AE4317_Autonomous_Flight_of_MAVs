 ...
 * @param _y 
 */
static inline void pprzlink_msg_v2_send_VISUALTARGET(struct pprzlink_msg * msg, uint16_t *_x, uint16_t *_y) {
  ...
  if (msg->trans->check_available_space(msg, _FD_ADDR, size)) {
    ...
    msg->trans->put_bytes(msg, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _x, 2);
    msg->trans->put_bytes(msg, _FD, DL_TYPE_UINT16, DL_FORMAT_SCALAR, (void *) _y, 2);
...
static inline void pprz_msg_send_VISUALTARGET(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, uint16_t *_x, uint16_t *_y) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_VISUALTARGET(&msg,_x,_y);
}
...
/** Getter for field x in message VISUALTARGET
  ...
  * @return 
  */
static inline uint16_t pprzlink_get_DL_VISUALTARGET_x(uint8_t * _payload __attribute__((unused)))
{
...
/** Getter for field y in message VISUALTARGET
  ...
  * @return 
  */
static inline uint16_t pprzlink_get_DL_VISUALTARGET_y(uint8_t * _payload __attribute__((unused)))
{
