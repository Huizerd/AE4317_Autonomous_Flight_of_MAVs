 ...
 * @param _offset 
 */
static inline void pprzlink_msg_v2_send_VFF_EXTENDED(struct pprzlink_msg * msg, float *_meas_baro, float *_meas_alt, float *_z, float *_zd, float *_zdd, float *_bias, float *_offset) {
...
static inline void pprz_msg_send_VFF_EXTENDED(struct transport_tx *trans, struct link_device *dev, uint8_t ac_id, float *_meas_baro, float *_meas_alt, float *_z, float *_zd, float *_zdd, float *_bias, float *_offset) {
    ...
    msg.receiver_id = 0;
    msg.component_id = 0;
    pprzlink_msg_v2_send_VFF_EXTENDED(&msg,_meas_baro,_meas_alt,_z,_zd,_zdd,_bias,_offset);
}
